...
oobj.compiler = (function () {
    ...
    var innerCompiler = function(classes) {        
        this.classes = [];
    ...
    var compiler = function(rootNamespace) {
    ...
    compiler.prototype.registerClass = function(className, parentClass, buildConstructorFunction /* any extra arguments are counted as dependencies */) {      
        ...
        var parentClass = !parentClass || parentClass === "oobj.object" ? "oobj.object" : this.namespaceCorrectly(parentClass);
